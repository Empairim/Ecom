        ...
        productsInfos.map((productInfo) => {
          ...
          return (
            <div className="flex mb-5 items-center" key={productInfo._id}>
              <div
                className="bg-emerald-100 p-3 rounded-xl shrink-0"
      ...
      <form action="/api/checkout" method="POST">
        <div className=" m-4">
          <input
            ...
            className=" bg-emerald-100 w-full rounded-lg px-4 py-2 mb-2"
            type="text"
        ...
        <div className=" mt-4">
          <div className="flex my-3">
            <h3 className="grow font-bold text-teal-400">Subtotal:</h3>
            <h3 className=" font-bold">${subtotal}</h3>
          </div>
          <div className="flex my-3">
            <h3 className="grow font-bold text-grey-400">Delivery:</h3>
            <h3 className=" font-bold">${deliveryPrice}</h3>
          </div>
          <div className="flex my-3 border-t border-dashed pt-3 border-emerald-500">
            <h3 className="grow font-bold text-emerald-400">Total:</h3>
        ...
        <button
          type="submit"
          className="bg-emerald-500 p-5 text-white w-full rounded-xl font-bold my-4 shadow-emerald-300 shadow-lg"
        >
          Pay ${total}
        </button>
      </form>
